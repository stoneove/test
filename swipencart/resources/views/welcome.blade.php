            ...
            <div class="container">
                        ...
                        @if (Route::has('login'))
                            @auth
                                ...
                                <a href="{{ url('/') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">
                                    Welcome to SwipenCart &nbsp;{{ Auth::user()->name }}</a>
                ...
                <div class="pull-right">
                    <ul class="header-top-links">
                        ...
                        &nbsp;
                        <li><a href="{{ url('vendor/signup') }}">Vendor sigup</a></li>
                        <li><a href="#">FAQ</a></li>
                                ...
                                @if (Route::has('login'))
                                    ...
                                    @auth
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            ...
                                            <li><i class="fa fa-lock" style="font-size:17px;margin-left:3px"></i><a href="route('logout')"
                        ...
                        <div id="product-slick-1" class="product-slick">
                            ...
                            <div class="product product-single">
                                <div class="product-thumb">
                                    ...
                                    <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick
                                        view</button>
                                    <img src="{{ asset('frontend/img/product08.jpg') }}" alt="">
                                </div>
                                <div class="product-body">
                                    <h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
                                    <div class="product-rating">
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- Product Single -->
                <div class="card col-md-3 col-sm-6 col-xs-6">
                    <div class="product product-single">
                        <div class="product-thumb">
                            <div class="product-label">
                                <span>New</span>
