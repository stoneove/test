                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                ...
                                @endif
                                    ...
                                    <form action="{{url('admin/reset_password')}}" method="post">
                                        @csrf
                                        <input type="hidden" name="token" value="{{$admin_data['token']}}">
                                        <div class="mb-3">
                                        <label><strong>Email</strong></label>
                                        <input type="text" class="form-control" name="email" readonly value="{{$admin_data['email']}}">
                                        </div>
                                        <div class="mb-3">
