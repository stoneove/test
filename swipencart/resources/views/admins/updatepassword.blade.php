                                ...
                                <form method="post" action="{{ url('admin/password-update') }}">
                                    ...
                                    <div class="mb-0">
                                        <label class="text-label form-label" for="dlab-password">Old Password<span
                                                style="color:rgb(255, 0, 0)"> *<span id="error_password" style="margin-left: 10px"></span></span></label>
                                    ...
                                    <button type="submit" name="submit" class="btn me-3 btn-success ">Update your
                                        password</button>
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <form method="post" action="{{ url('admin/profile-update') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control "
                                                ...
                                                required="" name="mobile" value="{{ Auth::guard('admin')->user()->mobile }}">
                                            <div class="invalid-feedback">
                                                Please Enter a username.
                                            </div>
                                        </div>
                                    ...
                                    <button type="submit" name="submit" class="btn me-2 btn-primary mt-2">Update your profile</button>
