    ...
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{url('admin/vendor_approve')}}">Vendor Approve</a></li>
                    <li><a href="{{url('admin/vendor_pending')}}">Vendor Pending</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{url('admin/password-update')}}">profile</a></li>
