...
$(document).ready(function () {
    $(".currentpassword").keyup(function () {
        ...
        $.ajax({
            ...
            type: "post",
            url: "/vendor/check_current_password",
            data: { currentpassword: currentpassword },

            success: function (response) {
                
                if(response == 'true'){
                   $('#error_password').html("<font color='green'>Current password is match</font>");
                   }else if(response == 'false'){
                    $('#error_password').html("<font color= 'red'>Current password is not match</font>");
...
// vendor credentials end




//new password eye visible and hide
